...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="whatsapp-fab fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp shadow-lg shadow-whatsapp/40 transition-transform hover:scale-110"
    >
