 ...
 * The article itself.
 *
 * The HTML comes from the CMS and has already been cleaned and rewritten by
 ...
 * `.post-body` rules in src/app/globals.css so the editor markup does not need
 * a class on every element.
 */
